...
describe PlacesController do
  ...
  describe "GET index" do
    it "assigns all places as @places" do
      ...
      get :index
      assigns(:places).to_a.should eq([place])
    end
  end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested place" do
        ...
        put :update, :id => place.id, :place => {'these' => 'params'}
      end

      it "assigns the requested place as @place" do
        place = Place.create! valid_attributes
        put :update, :id => place.id, :place => valid_attributes
        assigns(:place).should eq(place)
      end
    ...
    describe "with invalid params" do
      it "assigns the place as @place" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Place.any_instance.stub(:save).and_return(false)
        put :update, :id => place.id.to_s, :place => {}
        assigns(:place).should eq(place)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested place" do
      place = Place.create! valid_attributes
      expect {
        delete :destroy, :id => place.id.to_s
      }.to change(Place, :count).by(-1)
    end
